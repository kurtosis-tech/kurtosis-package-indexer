...
const (
	...
	KurtosisPackageIndexer_RereadLoggerLevel_FullMethodName = "/kurtosis_package_indexer.KurtosisPackageIndexer/RereadLoggerLevel"
)
...
type KurtosisPackageIndexerClient interface {
	...
	RereadLoggerLevel(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *kurtosisPackageIndexerClient) RereadLoggerLevel(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, KurtosisPackageIndexer_RereadLoggerLevel_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KurtosisPackageIndexerServer interface {
	...
	RereadLoggerLevel(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
}
...
func (UnimplementedKurtosisPackageIndexerServer) RereadLoggerLevel(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RereadLoggerLevel not implemented")
}
...
func _KurtosisPackageIndexer_RereadLoggerLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KurtosisPackageIndexerServer).RereadLoggerLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KurtosisPackageIndexer_RereadLoggerLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KurtosisPackageIndexerServer).RereadLoggerLevel(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KurtosisPackageIndexer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RereadLoggerLevel",
			Handler:    _KurtosisPackageIndexer_RereadLoggerLevel_Handler,
		},
	},
